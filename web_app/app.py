...
clean_model_path = os.path.join(BASE_DIR,'..','src', 'models', 'best_model_logistic_regression.pkl')
noisy_model_path = os.path.join(BASE_DIR,'..','src', 'models', 'logistic_regression_20250429_201248.pkl')
